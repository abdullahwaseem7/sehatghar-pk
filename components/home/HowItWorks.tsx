const STEPS = [
  ...
  },
  {
    num: "02",
    title: "Get Matched",
    desc: "We find you a verified nurse or attendant near you and confirm within 30 minutes.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0D7A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    num: "03",
    title: "Care Begins",
    desc: "Your nurse arrives on time and gets straight to work.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0D7A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    num: "04",
    title: "Rate &amp; Review",
    desc: "After the shift, let us know how it went. Your feedback helps other families.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0D7A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
